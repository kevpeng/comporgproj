//g++ -Wall main.cpp Simulate.cpp InstructionMemory.cpp InstructionParser.cpp ConfigFileParser.cpp DataMemory.cpp ShiftLeft.cpp signExtend.cpp ALU.cpp MUX.cpp ALUControl.cpp Control.cpp -o main
